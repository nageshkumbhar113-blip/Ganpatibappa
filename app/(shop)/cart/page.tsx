  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4 text-gray-400 px-4">
        ...
        <p className="text-sm text-center">Browse our collection and add Ganpati Murtis to your cart</p>
        <Link
          href="/products"
          className="mt-2 rounded-xl bg-orange-500 px-6 py-3 text-sm font-semibold text-white hover:bg-orange-600 transition-colors"
        >
          Shop Now
        </Link>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex items-center gap-1 rounded-full border border-gray-200 bg-white">
                  <button
                    ...
                    className="h-7 w-7 flex items-center justify-center text-gray-500 hover:text-gray-800"
                  >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 shadow-lg">
        <div className="max-w-2xl mx-auto flex items-center gap-4">
          ...
          <Link
            href="/checkout"
            className="flex-1 text-center rounded-xl bg-orange-500 py-3.5 text-sm font-bold text-white hover:bg-orange-600 transition-colors"
          >
            Proceed to Checkout
          </Link>
        </div>
