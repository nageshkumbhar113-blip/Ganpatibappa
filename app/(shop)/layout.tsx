...
async function getShopByRequest() {
    ...
    <>
      ...
      {marketing.google_analytics_id && (
        <>
          <script
            async
            src={`https://www.googletagmanager.com/gtag/js?id=${marketing.google_analytics_id}`}
          />
          <script
            dangerouslySetInnerHTML={{
              __html: `
                ...
                gtag('js', new Date());
                gtag('config', '${marketing.google_analytics_id}');
              `,
            }}
          />
        </>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            :root {
              --shop-primary: ${pwa.theme_color ?? '#ff6b00'};
              --shop-name: "${shop.name}";
            }
          `,
        }}
